    ...
    <div class="row justify-content-between g-3 mb-4">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
            <div class="name-details">
                ...
                <h4 class="comparissor_sub_type">Indexado</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="calculate-wrap">
                ...
                <div class="calculate-wrap-auto">
                    ...
                    <div class="calculate-box">
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp1">{{$afterofferEnergyresult[0]['valueprice_energy1']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp2">{{$afterofferEnergyresult[0]['valueprice_energy2']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp3">{{$afterofferEnergyresult[0]['valueprice_energy3']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp4">{{$afterofferEnergyresult[0]['valueprice_energy4']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp5">{{$afterofferEnergyresult[0]['valueprice_energy5']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp6">{{$afterofferEnergyresult[0]['valueprice_energy6']}}</div>
                        </div>
                    </div>
                </div>
                <div class="calculate-wrap-auto">
...
<div class="row g-3 mt-4 justify-content-between">
    <div class="col-xxl-6 col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="d-flex">
            <div class="back-prv-btn-box">
                <button type="button" class="back-prv-btn" onclick="indexStepfourBackBtn()">ATRÁS</button>
            </div>
    ...
    <div class="col-auto">
        <div class="back-prv-btn-box">
            ...
            <a href="{{url('user/download-index')}}/{{$price_id}}" target="_blank" class="back-prv-btn">DESCARGAR</a>
