            ...
            <tr>
                <td>
                    <div class="checkbox">
                        ...
                        <input type="radio" class="offercheck" onclick="offercheck({{$item['offer_id']}}, '{{$item['total_invoice_now'] < $item['totalSimulatedInvoice'] ? 'red' : 'green' }}')" name="offer" id="offer{{$key}}" value="{{$item['offer_id']}}">
