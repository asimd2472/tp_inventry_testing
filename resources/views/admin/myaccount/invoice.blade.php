        ...
        <tbody>
            <tr>
                <td style="padding: 15px 0; vertical-align: top;">
                    ...
                    <p style="padding: 3px 0 0 0; margin: 0; font-size: 14px;">{{$user->user_id}}</p>
                </td>
                                ...
                                <td style="padding-top: 20px;" >
                                    <table
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="padding: 10px;  border: 1px solid #dddddd; vertical-align: top; height:85px;">
                                                    ESTA FACTURA INCLUYE EL {{$iva}}% DE IVA
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
