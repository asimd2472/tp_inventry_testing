<div id="results_body" class="position-relative">
        ...
        <div class="col-lg-2 col-md-6 col-sm-6 col-12">
            <div class="company-list-icon-wrap">
                <span class="company-icon-box-wrap">
                    ...
                    <input type="hidden" name="offer" id="offer" value="{{$calculationdata['offer']}}">
                </span>
            </div>
        </div>
    </div> --}}
    ...
    @php
        // echo "<pre>";
        // print_r($comparissorinputdata);
        // echo "</pre>";

        $months = '';
        $other = '';
        if($comparissorinputdata['total_days']!=''){
            $months = round($comparissorinputdata['total_days'] / 30);
            $other = '';
            if($calculationdata['company_name']=='MEGA DELUXE'){
                $other = $months*5;
            }else if($calculationdata['company_name']=='PLENITUDE'){
                $other = $months*4;
            }else{
                $other = $comparissorinputdata['other_number'];
            }
        ...
        $text_notes_data = $text_notes ? json_decode($text_notes->text, true) : [];
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="calculate-wrap">
                ...
                <div class="calculate-wrap-auto">
                    <div class="calculate-box-head">PRECIO POTENCIA</div>
                    <div class="calculate-box">
                        <div class="value-box">
                ...
                <div class="calculate-wrap-auto">
                    <div class="calculate-box-head">IMPORTE POTENCIA OFERTA</div>
                    <div class="calculate-box">
                        <div class="value-box">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="calculate-wrap">
                ...
                <div class="calculate-wrap-auto">
                    ...
                    <div class="calculate-box">
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp1">{{$calculationdata['price_energyp1']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp2">{{$calculationdata['price_energyp2']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp3">{{$calculationdata['price_energyp3']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp4">{{$calculationdata['price_energyp4']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp5">{{$calculationdata['price_energyp5']}}</div>
                        </div>
                        <div class="value-box">
                            <div class="value-box-wrap value-area price_energyp6">{{$calculationdata['price_energyp6']}}</div>
                        </div>
                    </div>
                </div>
                <div class="calculate-wrap-auto">
            ...
            <div class="other-calculate-wrap">
                <div class="other-calculate">
                    ...
                    <div class="other-calculate-value">
                        ...
                        <div class="other-value other_number">{{$other.' €'}} </div>
                    </div>
                </div>
                <div class="other-calculate">
...
<input type="hidden" class="final_commission" value="{{number_format($calculationdata['final_commission'], 2, ',', '.')}}">

<div class="row mt-4 g-3 justify-content-between">
    <div class="col-xxl-6 col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
        <div class="d-flex">
            <div class="back-prv-btn-box">
                <button type="button" class="back-prv-btn" onclick="stepThreeBackBtn()">ATRÁS</button>
            </div>
            {{-- @if($calculationdata['company_name']=='ACCIONA' || $calculationdata['company_name']=='MEGA DELUXE' || $calculationdata['company_name']=='MEGA')
                <div class="other-calculate-note ms-3 mt-0" bis_skin_checked="1">
                    <p>Recuerda que los precios mostrados no incluyen los SSAA. La media del año 2024 fue de 0,01143.</p>    
                </div>
            @endif --}}
            <div class="other-calculate-note ms-3 mt-0" bis_skin_checked="1">
                @foreach ($text_notes_data as $key => $item)
                    <p class="{{$key!=0 ? 'mt-2' : '' }} text_notes_{{$key}}">{{$item}}</p>
                @endforeach
            </div>
        </div>
    </div>
    <div class="col-auto">
        <div class="back-prv-btn-box">
            ...
            <a href="{{url('user/download-fixed')}}/{{$price_id}}" target="_blank" class="back-prv-btn">DESCARGAR</a>
            @if($result_status == 'green')
                <button type="button" class="back-prv-btn" onclick="tramitar_btn('electric')">GUARDAR</button>
            @endif
