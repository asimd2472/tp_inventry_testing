...
<div class="row mt-4 justify-content-between">
    <div class="col-auto">
        <div class="back-prv-btn-box">
            <button type="button" class="back-prv-btn" onclick="stepThreeGasFixedBackBtn()">ATRÁS</button>
        </div>
    </div>
    <div class="col-auto">
        <div class="back-prv-btn-box">
            {{-- <button class="back-prv-btn" id="downloadPdfbtn">DESCARGAR</button> --}}
            <a href="{{url('user/gas-download-fixed')}}/{{$price_id}}" target="_blank" class="back-prv-btn">DESCARGAR</a>
            @if($result_status == 'green')
                <button type="button" class="back-prv-btn" onclick="tramitar_btn('gas')">GUARDAR</button>
            @endif
