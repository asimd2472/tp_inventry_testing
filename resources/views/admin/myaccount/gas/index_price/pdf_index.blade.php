                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="padding-bottom: 2rem; text-align: center;">
                                        <img style="width: 80px; display: block; margin-left: 1rem;" src="{{ $base64 }}" alt=""  />
                                    </td>
                                    <td style="padding-bottom: 2rem; width: 250px;">
                        ...
                        <table cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$comparissorinputdata['hired_potencyp3']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$calculationdata['price_potencyp3']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{round($calculationdata['potency_amount_offerp3'], 2)}} €</td>
                                </tr> --}}
                                {{-- <tr>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #464c9a; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$comparissorinputdata['hired_potencyp4']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$calculationdata['price_potencyp4']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$calculationdata['price_potencyp5']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$comparissorinputdata['hired_potencyp6']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                        ...
                        <table cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$afterofferEnergyresult[0]['valueprice_energy1']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$afterofferEnergyresult[0]['valueprice_energy2']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$afterofferEnergyresult[0]['valueprice_energy3']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$afterofferEnergyresult[0]['valueprice_energy4']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$afterofferEnergyresult[0]['valueprice_energy5']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                {{-- <tr>
                                    ...
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                        {{$afterofferEnergyresult[0]['valueprice_energy6']}}</td>
                                    <td
                                        style="padding: 0.425rem; text-transform: uppercase; color: #08adca; font-size: 0.875rem; font-weight: 700; text-align: center; border: 1px solid #dee2e6;">
                                ...
                                <tr>
                                    <td style="padding: 0.25rem;">
                                        <table cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td
                                                    style="padding: 0.425rem; text-transform: uppercase; height: 42px; color: #08adca; font-size:1.5rem; font-weight: 700;  text-align: center; border: 1px solid #dee2e6;">
